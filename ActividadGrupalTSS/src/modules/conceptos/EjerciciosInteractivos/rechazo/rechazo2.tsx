...
export default function Ejercicio2Rechazo() {
  ...
  const fx = (x: number): number => {
    ...
    if (x > 1 && x <= 5/3) return 15/8 - (9/8)*x;
    return 0;
  };
    ...
    <div className="min-h-screen bg-slate-50 p-6 font-sans text-slate-800">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
           <h1 className="text-2xl font-bold text-slate-900">Ejercicio 1.4: Método de Rechazo</h1>
           <div className="text-sm text-slate-500 text-right">
             <span className="block font-bold">Parámetros:</span>
             f(x) = 3/4 (0≤x≤1), 15/8-9x/8 (1≤x≤5/3)
           </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full max-w-lg bg-slate-50 border border-slate-200 rounded-lg p-4">
              <svg viewBox="0 0 400 220" className="w-full h-auto">
                ...
                <line x1="40" y1="60" x2="244" y2="60" stroke="#3b82f6" strokeWidth="4" strokeLinecap="round" />
             
                <line x1="244" y1="60" x2="380" y2="180" stroke="#ef4444" strokeWidth="4" strokeLinecap="round" />
               
                <line x1="244" y1="60" x2="244" y2="180" stroke="#94a3b8" strokeWidth="2" strokeDasharray="5,5" />
                
                
                <text x="40" y="200" className="text-xs font-bold fill-slate-600" textAnchor="middle">0</text>
                <text x="244" y="200" className="text-xs font-bold fill-slate-600" textAnchor="middle">1</text>
                <text x="380" y="200" className="text-xs font-bold fill-slate-600" textAnchor="middle">5/3</text>
                
                
                <text x="140" y="45" className="text-sm font-bold fill-blue-700">f(x) = 3/4</text>
                <text x="290" y="110" className="text-sm font-bold fill-red-700">f(x) = 15/8-9x/8</text>
            ...
            <div className="flex-1 space-y-4 text-sm">
              ...
              <div className="p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                <h3 className="font-bold text-red-900 mb-2">Segunda parte (1 ≤ x ≤ 5/3)</h3>
                <BlockMath math="f(x) = \frac{15}{8} - \frac{9}{8}x" />
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-slate-600">Intervalo: <InlineMath math="[a,b] = [0,\frac{5}{3}]" /></p>
                <div className="bg-slate-50 p-3 rounded border border-slate-200">
                  <BlockMath math="X = a + (b-a) \cdot R1" />
                  <BlockMath math="X = 0 + \left(\frac{5}{3}-0\right) \cdot R1 = \frac{5}{3}R1" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="bg-blue-50 p-3 rounded border border-blue-100">
                  ...
                  <BlockMath math="f(x = \frac{5}{3}R1) = \frac{3}{4}; \quad 0 \le R1 \le \frac{3}{5}" />
                </div>
                <div className="bg-red-50 p-3 rounded border border-red-100">
                  <p className="font-bold text-red-800 mb-1">2da parte</p>
                  <BlockMath math="f(x = \frac{5}{3}R1) = \frac{15}{8} - \frac{9}{8}x" />
                  <BlockMath math="f(x = \frac{5}{3}R1) = \frac{15}{8} - \frac{9}{8}\left[\frac{5}{3}R1\right]" />
                  <BlockMath math="f(x = \frac{5}{3}R1) = \frac{15}{8} - \frac{15}{8}R1; \quad \frac{3}{5} \le R1 \le 1" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="bg-red-50 p-3 rounded border border-red-100">
                  <p className="font-bold text-red-800 mb-1">2da parte</p>
                  <BlockMath math="R2 \le \left(\frac{15}{8} - \frac{15}{8}R1\right) \cdot \frac{4}{3}" />
                  <BlockMath math="R2 \le \frac{5}{2} - \frac{5}{2}R1" />
                </div>
              </div>
            </div>
                ...
                <table className="w-full text-sm text-left">
                  <thead className="bg-white text-slate-500 border-b border-slate-100">
                    <tr>
                      ...
                      <th className="px-3 py-3 font-medium text-xs">R₂</th>
                      <th className="px-3 py-3 font-medium text-xs">X = (5/3)R₁</th>
